...
- (void)viewDidLoad
{
    ...
    kaimages=[[NSArray alloc]initWithObjects: [UIImage imageNamed:@"chikmangalur"], [UIImage imageNamed:@"coorg"], [UIImage imageNamed:@"mangalore"],[UIImage imageNamed:@"mysore"],nil];
    ...
    apimages=[[NSArray alloc]initWithObjects: [UIImage imageNamed:@"charminar"], [UIImage imageNamed:@"gandikota"],[UIImage imageNamed:@"tirupathi"],[UIImage imageNamed:@"Hampi"], nil];
